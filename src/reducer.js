let initialState = {
    ...
    connections: [{id: 3, name: 'yueying', relationship:'friend', accepted: true},
    {id: 4, name: 'rob', relationship: 'friend', accepted: true}, 
    {id: 5, name: 'jenny', relationship: 'family', accepted: true},
    {id: 6, name: 'danny', relationship: 'friend', accepted: false}],
    activities: [
